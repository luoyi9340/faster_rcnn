...
class ResNet34(tf.keras.layers.Layer):
    ...
    '''
    def __init__(self, training=True, scaling=CNNS.get_feature_map_scaling(), base_channel_num=32, kernel_initializer = tf.initializers.HeNormal(), bias_initializer = tf.initializers.Zeros(), **kwargs):
        '''
